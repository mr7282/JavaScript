...
/**
    ...
    const settings = {
      ...
      const player = {
        ...
        // Второй вариант решения второго задания этот вариант оставляет игрока
        // на месте в том числе, в тот момент, когда используются 1, 3, 7, 9, и 
        // игрок находится в крайнем положении только или по Х или только по Y
        //   switch (direction) {
        //     case 2:
        //         if (this.y < 9) {
        //             this.y++;
        ...
        /**
         * Проверяет допустимость хода, вслучае недопустимости проводит обратные (от move()) арифметические действия. В случае если крайнее положение только по одной из оси координат, то смещение по допустимой оси продолжится.
         */
        chekingMove() {
            if (this.x < 0) 
                this.x++;
